  ...
  return (
    ...
    >
      <div
        ...
        className="bg-white rounded-2xl shadow-2xl border border-neutral-200/90 w-full max-w-lg overflow-hidden flex flex-col max-h-[90vh]"
        ...
        <form onSubmit={handleSubmit} className="p-6 overflow-y-auto space-y-4 flex-1">
          ...
          <div className="space-y-1.5">
            ...
            <input
              ...
              className={`w-full px-3.5 py-2 text-xs rounded-xl border bg-white text-neutral-900 shadow-xs focus:outline-none focus:ring-2 transition-all ${
                errors.name
          ...
          <div className="space-y-1.5">
            ...
            <textarea
              ...
              className="w-full px-3.5 py-2 text-xs rounded-xl border border-neutral-300 bg-white text-neutral-900 shadow-xs focus:outline-none focus:ring-2 focus:ring-blue-100 focus:border-blue-500 transition-all resize-none"
            />
          </div>
          ...
          <div className="space-y-2 pt-1">
            <div className="flex items-center justify-between">
              ...
              {/* Tab Selector */}
              <div className="flex items-center p-0.5 bg-neutral-100 rounded-lg text-[11px] font-medium text-neutral-600">
                <button
                  type="button"
                  onClick={() => setImageTab('presets')}
                  className={`px-2.5 py-1 rounded-md transition-all cursor-pointer ${
                    imageTab === 'presets' ? 'bg-white text-blue-700 shadow-xs font-semibold' : 'hover:text-neutral-900'
                  }`}
                >
                  Presets
                </button>
                <button
                  ...
                  className={`px-2.5 py-1 rounded-md transition-all cursor-pointer ${
                    imageTab === 'url' ? 'bg-white text-blue-700 shadow-xs font-semibold' : 'hover:text-neutral-900'
                  }`}
                >
                  Image URL
                </button>
                <button
                  ...
                  className={`px-2.5 py-1 rounded-md transition-all cursor-pointer ${
                    imageTab === 'upload' ? 'bg-white text-blue-700 shadow-xs font-semibold' : 'hover:text-neutral-900'
                  }`}
                >
                  Upload
                </button>
              ...
              <div className="grid grid-cols-3 gap-2 pt-1">
                {PRESET_DEPARTMENT_IMAGES.map((preset, idx) => {
                  ...
                  return (
                    ...
                    >
                      <div className="h-16 w-full bg-neutral-100 relative">
                        <img
                          src={preset.url}
                          alt={preset.title}
                      ...
                      <div className="p-1.5 bg-white">
                        ...
                        <p className="text-[9px] text-neutral-500 truncate">{preset.category}</p>
                      </div>
                    </button>
                  );
                })}
              ...
              <div className="space-y-1.5 pt-1">
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-9 pr-3.5 py-2 text-xs rounded-xl border border-neutral-300 bg-white text-neutral-900 shadow-xs focus:outline-none focus:ring-2 focus:ring-blue-100 focus:border-blue-500 transition-all"
                  />
                </div>
              </div>
            )}
            ...
            {imageTab === 'upload' && (
              <div className="pt-1">
                ...
                <button
                  ...
                  className="w-full border-2 border-dashed border-neutral-300 hover:border-blue-400 rounded-xl p-4 text-center bg-neutral-50/50 hover:bg-blue-50/30 transition-all cursor-pointer group"
                >
                  <Upload className="w-5 h-5 mx-auto text-neutral-400 group-hover:text-blue-600 transition-colors mb-1.5" />
                  <p className="text-xs font-semibold text-neutral-700 group-hover:text-blue-700">
                    Click to browse an image file
                  </p>
                  <p className="text-[10px] text-neutral-500 mt-0.5">PNG, JPG, WebP, or SVG</p>
                </button>
              </div>
            )}

            {/* Live Thumbnail Preview */}
            <div className="mt-2 flex items-center gap-3 p-2.5 bg-neutral-50 rounded-xl border border-neutral-200/80">
              <div className="w-16 h-12 rounded-lg bg-neutral-200 overflow-hidden flex items-center justify-center flex-shrink-0 border border-neutral-300/60 shadow-xs">
          ...
          <div className="pt-3 border-t border-neutral-200 flex items-center justify-end gap-2.5">
            <button
              type="button"
              onClick={closeDepartmentModal}
              className="px-4 py-2 rounded-xl border border-neutral-300 text-xs font-medium text-neutral-700 hover:bg-neutral-50 transition-colors cursor-pointer"
            >
              Cancel
            </button>
            <button
