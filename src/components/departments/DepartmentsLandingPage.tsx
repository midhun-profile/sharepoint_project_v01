...
export function DepartmentsLandingPage() {
  ...
  return (
    <div className="min-h-screen w-full bg-neutral-100/70 flex flex-col font-sans text-neutral-900 antialiased selection:bg-blue-100">
      ...
      <header className="sticky top-0 z-40 bg-white/95 backdrop-blur-md border-b border-neutral-200/80 shadow-2xs">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="flex items-center gap-2">
                ...
                <span className="px-1.5 py-0.5 rounded-full text-[10px] font-semibold bg-teal-50 text-teal-700 border border-teal-200">
          ...
          {/* Right Action: Add Department Button */}
          <div className="flex items-center gap-3">
            <button
      ...
      <section className="bg-white border-b border-neutral-200/70 pt-8 pb-7 px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex items-center gap-3 w-full md:w-auto">
            <div className="relative flex-1 sm:w-72">
              ...
              <input
                ...
                className="w-full pl-9 pr-3.5 py-2 text-xs rounded-xl border border-neutral-300 bg-neutral-50/50 hover:bg-white focus:bg-white text-neutral-900 shadow-2xs focus:outline-none focus:ring-2 focus:ring-blue-100 focus:border-blue-500 transition-all"
              />
            </div>

            <div className="flex items-center px-3 py-2 bg-neutral-100 rounded-xl text-xs font-medium text-neutral-600 flex-shrink-0">
      ...
      <main className="flex-1 max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-8">
        {filteredDepartments.length === 0 ? (
          <div className="text-center py-16 bg-white rounded-2xl border border-dashed border-neutral-300 p-8 max-w-md mx-auto">
            <div className="w-12 h-12 rounded-2xl bg-neutral-100 text-neutral-400 flex items-center justify-center mx-auto mb-3">
              <Building2 className="w-6 h-6" />
            </div>
            <h3 className="text-sm font-bold text-neutral-800">No departments found</h3>
            ...
            {filteredDepartments.map((dept, index) => {
              ...
              return (
                <div
                  ...
                  className="group bg-white rounded-2xl border border-neutral-200/90 hover:border-blue-400 shadow-xs hover:shadow-lg transition-all duration-200 flex flex-col overflow-hidden cursor-pointer relative"
                  tabIndex={0}
                  onKeyDown={(e) => {
                ...
                >
                  ...
                  <div className="h-44 w-full bg-neutral-200 relative overflow-hidden flex-shrink-0">
                    <img
                      src={dept.imageUrl}
                      alt={dept.name}
                    ...
                    <div
                      className="absolute top-2.5 left-2.5 flex items-center gap-1 bg-white/90 backdrop-blur-md p-1 rounded-lg shadow-sm opacity-90 group-hover:opacity-100 transition-opacity"
                    ...
                    >
                      <button
                        ...
                        className="p-1 rounded text-neutral-500 hover:text-neutral-900 hover:bg-neutral-100 disabled:opacity-20 disabled:hover:bg-transparent cursor-pointer"
                    ...
                    <div
                      className="absolute top-2.5 right-2.5 flex items-center gap-1 bg-white/90 backdrop-blur-md p-1 rounded-lg shadow-sm opacity-90 group-hover:opacity-100 transition-opacity"
                      onClick={(e) => e.stopPropagation()}
                    >
                      <button
                        type="button"
                        ...
                        className="p-1.5 rounded-md text-neutral-600 hover:text-blue-600 hover:bg-blue-50 transition-colors cursor-pointer"
                      ...
                      <button
                        ...
                        className="p-1.5 rounded-md text-neutral-600 hover:text-rose-600 hover:bg-rose-50 transition-colors cursor-pointer"
                  ...
                  {deleteConfirmId === dept.id && (
                    <div
                      className="absolute inset-0 bg-white/95 backdrop-blur-xs p-5 flex flex-col items-center justify-center text-center z-20 animate-in fade-in duration-100"
                      onClick={(e) => e.stopPropagation()}
                    >
                      <div className="w-9 h-9 rounded-full bg-rose-50 text-rose-600 flex items-center justify-center mb-2">
                        <Trash2 className="w-4 h-4" />
                      </div>
                      <h4 className="text-xs font-bold text-neutral-900">Delete {dept.name}?</h4>
